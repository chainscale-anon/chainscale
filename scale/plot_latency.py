...
def plot(dataframedict):
        ...
        plt.xlabel("No. of Contracts")
        plt.ylabel("Confirmation Time (x 1000s)")
        fig.legend(loc="upper left", ncol=1, bbox_to_anchor=(0.14, 0.9), fontsize="x-small")
        plt.grid()
